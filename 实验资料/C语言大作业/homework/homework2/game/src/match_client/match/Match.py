...
class Iface(object):
    ...
    def list_user(self, output_file, info):
        """
        Parameters:
         - output_file
         - info
    ...
    def get_random(self, num, output_file, info):
        """
        Parameters:
         - num
         - output_file
...
class Client(Iface):
    ...
    def list_user(self, output_file, info):
        ...
        """
        self.send_list_user(output_file, info)
        return self.recv_list_user()

    def send_list_user(self, output_file, info):
        self._oprot.writeMessageBegin('list_user', TMessageType.CALL, self._seqid)
        args = list_user_args()
    ...
    def recv_list_user(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = list_user_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "list_user failed: unknown result")
    ...
    def get_random(self, num, output_file, info):
        ...
        """
        self.send_get_random(num, output_file, info)
        return self.recv_get_random()

    def send_get_random(self, num, output_file, info):
        self._oprot.writeMessageBegin('get_random', TMessageType.CALL, self._seqid)
    ...
    def recv_get_random(self):
        ...
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_random failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["list_user"] = Processor.process_list_user
        self._processMap["get_random"] = Processor.process_get_random
    ...
    def process_list_user(self, seqid, iprot, oprot):
        args = list_user_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = list_user_result()
        try:
            result.success = self._handler.list_user(args.output_file, args.info)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("list_user", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_get_random(self, seqid, iprot, oprot):
        args = get_random_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_random_result()
        try:
            result.success = self._handler.get_random(args.num, args.output_file, args.info)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_random", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class list_user_args(object):
    ...
    def __init__(self, output_file=None, info=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.output_file = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_user_args')
        if self.output_file is not None:
            oprot.writeFieldBegin('output_file', TType.STRING, 1)
            oprot.writeString(self.output_file.encode('utf-8') if sys.version_info[0] == 2 else self.output_file)
            oprot.writeFieldEnd()
        if self.info is not None:
            oprot.writeFieldBegin('info', TType.STRING, 2)
            oprot.writeString(self.info.encode('utf-8') if sys.version_info[0] == 2 else self.info)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_user_args)
list_user_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'output_file', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'info', 'UTF8', None, ),  # 2
)


class list_user_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_user_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_user_result)
list_user_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)


class get_random_args(object):
    """
    Attributes:
     - num
     - output_file
    ...
    def __init__(self, num=None, output_file=None, info=None,):
        self.num = num
        self.output_file = output_file
        self.info = info
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_random_args')
        if self.num is not None:
            oprot.writeFieldBegin('num', TType.I32, 1)
            oprot.writeI32(self.num)
            oprot.writeFieldEnd()
        if self.output_file is not None:
            oprot.writeFieldBegin('output_file', TType.STRING, 2)
            oprot.writeString(self.output_file.encode('utf-8') if sys.version_info[0] == 2 else self.output_file)
            oprot.writeFieldEnd()
        if self.info is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_random_args)
get_random_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'num', None, None, ),  # 1
    (2, TType.STRING, 'output_file', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'info', 'UTF8', None, ),  # 3
)


class get_random_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_random_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_random_result)
get_random_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
