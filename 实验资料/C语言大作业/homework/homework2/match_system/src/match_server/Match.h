...
class MatchIf {
 public:
  ...
  virtual int32_t list_user(const std::string& output_file, const std::string& info) = 0;
  virtual int32_t get_random(const int32_t num, const std::string& output_file, const std::string& info) = 0;
};
...
class MatchNull : virtual public MatchIf {
 public:
  ...
  int32_t list_user(const std::string& /* output_file */, const std::string& /* info */) override {
    int32_t _return = 0;
    return _return;
  }
  int32_t get_random(const int32_t /* num */, const std::string& /* output_file */, const std::string& /* info */) override {
    int32_t _return = 0;
    return _return;
  }
};
...
typedef struct _Match_list_user_args__isset {
  _Match_list_user_args__isset() : output_file(false), info(false) {}
  bool output_file :1;
  bool info :1;
} _Match_list_user_args__isset;

class Match_list_user_args {
 public:

  Match_list_user_args(const Match_list_user_args&);
  Match_list_user_args& operator=(const Match_list_user_args&);
  Match_list_user_args() noexcept
                       : output_file(),
                         info() {
  }

  virtual ~Match_list_user_args() noexcept;
  std::string output_file;
  std::string info;

  _Match_list_user_args__isset __isset;

  void __set_output_file(const std::string& val);

  void __set_info(const std::string& val);

  bool operator == (const Match_list_user_args & rhs) const
  {
    if (!(output_file == rhs.output_file))
      return false;
    if (!(info == rhs.info))
      return false;
    return true;
  ...
  bool operator < (const Match_list_user_args & ) const;
...
class Match_list_user_pargs {
 public:


  virtual ~Match_list_user_pargs() noexcept;
...
typedef struct _Match_list_user_result__isset {
  _Match_list_user_result__isset() : success(false) {}
  bool success :1;
} _Match_list_user_result__isset;

class Match_list_user_result {
 public:

  Match_list_user_result(const Match_list_user_result&) noexcept;
  Match_list_user_result& operator=(const Match_list_user_result&) noexcept;
  Match_list_user_result() noexcept
                         : success(0) {
  }

  virtual ~Match_list_user_result() noexcept;
  int32_t success;

  _Match_list_user_result__isset __isset;

  void __set_success(const int32_t val);

  bool operator == (const Match_list_user_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Match_list_user_result & ) const;
...
typedef struct _Match_list_user_presult__isset {
  _Match_list_user_presult__isset() : success(false) {}
  bool success :1;
} _Match_list_user_presult__isset;

class Match_list_user_presult {
 public:


  virtual ~Match_list_user_presult() noexcept;
  int32_t* success;

  _Match_list_user_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _Match_get_random_args__isset {
  _Match_get_random_args__isset() : num(false), output_file(false), info(false) {}
  bool num :1;
  bool output_file :1;
  bool info :1;
} _Match_get_random_args__isset;

class Match_get_random_args {
 public:

  Match_get_random_args(const Match_get_random_args&);
  Match_get_random_args& operator=(const Match_get_random_args&);
  Match_get_random_args() noexcept
                        : num(0),
                          output_file(),
                          info() {
  }

  virtual ~Match_get_random_args() noexcept;
  int32_t num;
  std::string output_file;
  std::string info;

  _Match_get_random_args__isset __isset;
  ...
  bool operator == (const Match_get_random_args & rhs) const
  {
    if (!(num == rhs.num))
      return false;
    if (!(output_file == rhs.output_file))
  ...
  bool operator < (const Match_get_random_args & ) const;
...
class Match_get_random_pargs {
 public:


  virtual ~Match_get_random_pargs() noexcept;
  const int32_t* num;
  const std::string* output_file;
  const std::string* info;
...
typedef struct _Match_get_random_result__isset {
  _Match_get_random_result__isset() : success(false) {}
  bool success :1;
} _Match_get_random_result__isset;

class Match_get_random_result {
 public:

  Match_get_random_result(const Match_get_random_result&) noexcept;
  Match_get_random_result& operator=(const Match_get_random_result&) noexcept;
  Match_get_random_result() noexcept
                          : success(0) {
  }

  virtual ~Match_get_random_result() noexcept;
  int32_t success;

  _Match_get_random_result__isset __isset;

  void __set_success(const int32_t val);

  bool operator == (const Match_get_random_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Match_get_random_result & ) const;
...
typedef struct _Match_get_random_presult__isset {
  _Match_get_random_presult__isset() : success(false) {}
  bool success :1;
} _Match_get_random_presult__isset;

class Match_get_random_presult {
 public:


  virtual ~Match_get_random_presult() noexcept;
  int32_t* success;

  _Match_get_random_presult__isset __isset;
...
class MatchClient : virtual public MatchIf {
 ...
 public:
  ...
  int32_t list_user(const std::string& output_file, const std::string& info) override;
  void send_list_user(const std::string& output_file, const std::string& info);
  int32_t recv_list_user();
  int32_t get_random(const int32_t num, const std::string& output_file, const std::string& info) override;
  void send_get_random(const int32_t num, const std::string& output_file, const std::string& info);
  int32_t recv_get_random();
 protected:
...
class MatchProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_list_user(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_get_random(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  MatchProcessor(::std::shared_ptr<MatchIf> iface) :
    ...
    processMap_["list_user"] = &MatchProcessor::process_list_user;
    processMap_["get_random"] = &MatchProcessor::process_get_random;
  }
...
class MatchMultiface : virtual public MatchIf {
 ...
 public:
  ...
  int32_t list_user(const std::string& output_file, const std::string& info) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->list_user(output_file, info);
    }
    return ifaces_[i]->list_user(output_file, info);
  }
  ...
  int32_t get_random(const int32_t num, const std::string& output_file, const std::string& info) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_random(num, output_file, info);
    }
    return ifaces_[i]->get_random(num, output_file, info);
  }
  ...
  MatchConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  int32_t list_user(const std::string& output_file, const std::string& info) override;
  int32_t send_list_user(const std::string& output_file, const std::string& info);
  int32_t recv_list_user(const int32_t seqid);
  int32_t get_random(const int32_t num, const std::string& output_file, const std::string& info) override;
  int32_t send_get_random(const int32_t num, const std::string& output_file, const std::string& info);
  int32_t recv_get_random(const int32_t seqid);
 protected:
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
