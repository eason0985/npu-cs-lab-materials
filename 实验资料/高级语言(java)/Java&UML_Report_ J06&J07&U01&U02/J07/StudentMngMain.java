...
class Student implements Serializable {
    ...
    public Student(String studentId, String name, String birthDate, String gender, String className) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    Student student = new Student(studentId, name, birthDate, gender, className);
